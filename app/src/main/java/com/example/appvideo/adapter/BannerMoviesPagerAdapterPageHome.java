...
public class BannerMoviesPagerAdapterPageHome extends PagerAdapter {

    Context context;
    List<CategoryItem> categoryItems;

    public BannerMoviesPagerAdapterPageHome(Context context, List<CategoryItem> categoryItems) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
     View view = LayoutInflater.from(context).inflate(R.layout.banner_movie_layout_page_home,null);
